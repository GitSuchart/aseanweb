Concrete.event.bind('btBlockMultiple.link.open', function (options, settings) {
...
});Concrete.event.bind('btBlockMultiple.item.edit.open', function (options, settings) {
    var container = $('#' + settings.id);
    ...
    var ftImageImage = $(newField).find('.ft-image-item-image-file-selector');
            ...
            var pageSelectorImage = $(newField).find('.ft-image-item-image-page-selector');
    ...
    blockDesignerEditor('#' + ($(newField).find('textarea.ft-item-content').attr('id')).replace(/(:|\.|\[|\]|,|=|@)/g, "\\$1"));
        $.each($(newField).find('.ft-smart-link'), function () {
            var ftSmartLinkImage = $(this).find('.ft-smart-link-item-link-image-selector');
            ...
            var ftSmartLinkFile = $(this).find('.ft-smart-link-item-link-file-selector');
            ...
            var ftSmartLinkPage = $(this).find('.ft-smart-link-item-link-page-selector');
