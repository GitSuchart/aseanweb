...
</div><?php $link_ContainerID = 'btBlockCustomLink-link-container-' . $identifier_getString; ?>
...
<script type="text/javascript">
	Concrete.event.publish('btBlockCustomLink.link.open', {id: '<?php echo $link_ContainerID; ?>'});
...
<?php $repeatable_container_id = 'btBlockCustomLink-item-container-' . $identifier_getString; ?>
    <div id="<?php echo $repeatable_container_id; ?>">
        ...
        <script class="repeatableTemplate" type="text/x-handlebars-template">
            <div class="sortable-item" data-id="{{id}}">
                ...
                <div class="sortable-item-inner">            <?php $link_ContainerID = 'btBlockCustomLink-link-container-' . $identifier_getString; ?>
<div class="ft-smart-link" id="<?php echo $link_ContainerID; ?>">
	<div class="form-group">
...
<script type="text/javascript">
    Concrete.event.publish('btBlockCustomLink.item.edit.open', {id: '<?php echo $repeatable_container_id; ?>'});
