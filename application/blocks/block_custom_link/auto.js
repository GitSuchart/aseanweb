Concrete.event.bind('btBlockCustomLink.link.open', function (options, settings) {
...
});Concrete.event.bind('btBlockCustomLink.item.edit.open', function (options, settings) {
    var container = $('#' + settings.id);
